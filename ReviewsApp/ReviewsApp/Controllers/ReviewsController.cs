...
namespace ReviewsApp.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductId,ProductReview,Link")] Review review)
        {
            ...
            ViewBag.ProductId = new SelectList(db.Products, "Id", "Name", review.ASIN);
            return View(review);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductId,ProductReview,Link")] Review review)
        {
            if (ModelState.IsValid)
            {
